export const technologiesData: {
    ...
    },
    {
        ...
        mobileOriginPosition: [-1, 0.35, -1.5],
        finalPosition: [1.3, -0.5, -3],
        mobileFinalPosition: [-0.1, 0.1, 2.7],
        scale: 0.15,
        mobileScale: 0.09,
        rotation: [-0.1, -0.2, 0],
        decalScale: 1.2,
    ...
    },
    {
        ...
        mobileOriginPosition: [0, 1.2, -3.5],
        finalPosition: [-1.6, -0.35, -3],
        mobileFinalPosition: [0, -0.25, 3.1],
        scale: 0.2,
        mobileScale: 0.15,
        rotation: [0.1, 0.3, 0],
    ...
    },
    {
        ...
        mobileOriginPosition: [0.6, -0.3, -1.5],
        finalPosition: [0.2, 0.75, 3],
        mobileFinalPosition: [0.35, -0.25, 2.8],
        scale: 0.15,
        mobileScale: 0.11,
        rotation: [0, 0, 0],
        decalScale: 1,
    ...
    },
    {
        name: 'Three.JS',
        originPosition: [1.3, 1.5, -1.7],
        mobileOriginPosition: [0.8, 0.5, -1.5],
        finalPosition: [1.2, 0.5, 3],
        mobileFinalPosition: [0.2, 0.05, 3.3],
        scale: 0.15,
        mobileScale: 0.09,
        rotation: [0, -0.1, 0],
    ...
    },
    {
        ...
        mobileOriginPosition: [-0.7, -0.006, -1.5],
        finalPosition: [-1.4, 0.6, -3],
        mobileFinalPosition: [-0.35, -0.11, 3.2],
        scale: 0.2,
        mobileScale: 0.1,
        rotation: [0.2, 0.2, 0],
    ...
    },
    {
        ...
        mobileOriginPosition: [-1.2, -0.4, -1.5],
        finalPosition: [-1.7, -0.7, -3],
        mobileFinalPosition: [-0.26, -0.42, 3.2],
        scale: 0.12,
        mobileScale: 0.08,
        rotation: [0, 0.3, 0],
    ...
    },
    {
        ...
        mobileOriginPosition: [2, -0.8, -1.5],
        finalPosition: [-0.25, 0.75, -3],
        mobileFinalPosition: [0.1, -0.5, 3.2],
        scale: 0.1,
        mobileScale: 0.08,
        rotation: [0.2, 0.3, 0],
