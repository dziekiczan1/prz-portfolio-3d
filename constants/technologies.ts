export const technologiesData: {
    ...
    {
        name: 'Asana',
        originPosition: [3.5, 0.5, -1.7],
        mobileOriginPosition: [0, 0, -1.7],
        finalPosition: [1.4, 0.2, 3],
    ...
    {
        name: 'Framer Motion',
        originPosition: [-1.9, 1.5, -1.7],
        mobileOriginPosition: [0, 0, -1.7],
        finalPosition: [-1, 0.75, -3],
        mobileFinalPosition: [4, -4, -3],
        scale: 0.08,
        rotation: [0.2, 0.2, 0],
